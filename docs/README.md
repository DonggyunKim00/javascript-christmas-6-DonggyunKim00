...
- [ ] : 날짜 정상 입력일때, 날짜를 저장한다.
- [ ] : 주문 형식 정상 입력일때, 주문 목록을 생성시도한다.
- 예외 처리
  - [ ] : 빈 값이 입력되면 예외처리한다.
  - [ ] : 날짜 입력을 받을때, 숫자가 아니라면 예외처리한다.
  - [ ] : 날짜 입력을 받을때, 1~31 사이의 번호를 벗어나면 예외처리한다.
  - [ ] : 주문 입력을 받을떄, 주문 형식을 벗어나면 예외처리한다.
  - [ ] : 주문 입력을 받을때, 메뉴 갯수가 1보다 작다면 예외처리한다.
  - [ ] : 주문 입력을 받을때, 메뉴 이름이 중복된다면 예외처리한다.

### MenuTest

- [ ] : 입력받은 메뉴가 메뉴판에 있을때, 주문받은 메뉴정보를 생성한다.
- 예외 처리
